...
Start-Window -Title "Embedding Service (8002)" -WorkingDir (Join-Path $repoRoot "services/embedding-service") -Command "python -m uvicorn src.main:app --reload --host 0.0.0.0 --port 8002"
